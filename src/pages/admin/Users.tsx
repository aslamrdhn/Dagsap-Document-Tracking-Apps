...
export default function Users() {
  ...
  if (loading)
    return <div className="p-8 text-[#888888] font-medium">Loading users interface...</div>;
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0">
        <div>
          ...
          <p className="text-[#666666] text-sm mt-1 font-medium">
            Manage access controls, couriers, and administrators.
          </p>
        </div>
        <button
            ...
            <tbody className="divide-y divide-[#E5E5E4] text-sm">
              {users.map((u) => (
                <tr key={u.id} className="hover:bg-[#F9F9F8] transition-colors group">
                  ...
                  <td className="p-4 text-[#555555] font-medium text-xs">
                    {u.defaultLocation?.name || (
                      <span className="text-[#A0A0A0] italic">Unassigned</span>
                    )}
                  </td>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 border border-[#E5E5E4] rounded-lg text-sm bg-white font-mono text-[#111111] focus:border-[#111111] focus:ring-1 focus:ring-[#111111] outline-none transition-all"
