      ...
      <header className="bg-[#800000] text-white px-5 pb-4 pt-[max(env(safe-area-inset-top),1rem)] flex justify-between items-center shadow-md shrink-0">
        <div className="flex items-center">
          ...
          <div
            ...
            className="hidden items-center p-2 border border-dashed border-white/30 rounded bg-black/20 text-center"
          >
          ...
          <div>
            <h1 className="font-bold text-[13px] leading-tight tracking-tight">
              Dagsap Document
              <br />
              Tracking System
            </h1>
